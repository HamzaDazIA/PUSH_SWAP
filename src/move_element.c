...
/*   Updated: 2025/01/31 07:42:58 by hdazia           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../push_swap.h"

static void	rrr_costs(int *cost_a, int *cost_b, t_stack **stack_a,
			t_stack **stack_b)
{
...
static void	rr_costs(int *cost_a, int *cost_b, t_stack **stack_a,
			t_stack **stack_b)
{
	while ((*cost_a) > 0 && (*cost_b) > 0)
	{
